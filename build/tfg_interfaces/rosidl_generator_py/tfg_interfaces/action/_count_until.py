...
class Metaclass_CountUntil_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tfg_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_Goal')
            logger.debug(
...
class Metaclass_CountUntil_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tfg_interfaces.action import CountUntil
...
class CountUntil_SendGoal_Request(metaclass=Metaclass_CountUntil_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'tfg_interfaces/CountUntil_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from tfg_interfaces.action._count_until import CountUntil_Goal
...
class CountUntil_SendGoal_Event(metaclass=Metaclass_CountUntil_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tfg_interfaces/CountUntil_SendGoal_Request, 1>',
        'response': 'sequence<tfg_interfaces/CountUntil_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tfg_interfaces.action import CountUntil_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from tfg_interfaces.action import CountUntil_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_CountUntil_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tfg_interfaces.action import _count_until
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    from tfg_interfaces.action._count_until import CountUntil_SendGoal_Request as Request
    from tfg_interfaces.action._count_until import CountUntil_SendGoal_Response as Response
    from tfg_interfaces.action._count_until import CountUntil_SendGoal_Event as Event
...
class CountUntil_GetResult_Response(metaclass=Metaclass_CountUntil_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'tfg_interfaces/CountUntil_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from tfg_interfaces.action._count_until import CountUntil_Result
...
class CountUntil_GetResult_Event(metaclass=Metaclass_CountUntil_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<tfg_interfaces/CountUntil_GetResult_Request, 1>',
        'response': 'sequence<tfg_interfaces/CountUntil_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tfg_interfaces.action import CountUntil_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from tfg_interfaces.action import CountUntil_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_CountUntil_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    from tfg_interfaces.action._count_until import CountUntil_GetResult_Request as Request
    from tfg_interfaces.action._count_until import CountUntil_GetResult_Response as Response
    from tfg_interfaces.action._count_until import CountUntil_GetResult_Event as Event
...
class Metaclass_CountUntil_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_FeedbackMessage(metaclass=Metaclass_CountUntil_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'tfg_interfaces/CountUntil_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['tfg_interfaces', 'action'], 'CountUntil_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from tfg_interfaces.action._count_until import CountUntil_Feedback
...
class Metaclass_CountUntil(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tfg_interfaces.action.CountUntil')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil(metaclass=Metaclass_CountUntil):
    ...
    from tfg_interfaces.action._count_until import CountUntil_Goal as Goal
    # The result message defined in the action definition.
    from tfg_interfaces.action._count_until import CountUntil_Result as Result
    # The feedback message defined in the action definition.
    from tfg_interfaces.action._count_until import CountUntil_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from tfg_interfaces.action._count_until import CountUntil_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from tfg_interfaces.action._count_until import CountUntil_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from tfg_interfaces.action._count_until import CountUntil_FeedbackMessage as FeedbackMessage
