...
Estas diferencias hacen ver que en caso de haber errores o limitaciones del sistema, éstos no están relacionados con la validez del modelo cinemático, sino con aspectos de implementación y eficiencia. En por ello que puede afirmarse que el comportamiento matemático del modelo es consistente en ambos lenguajes, donde las únicas variaciones observadas entre Python y C++ quedan limitadas únicamente al coste computacional asociado a cada una de sus implementaciones.

\vspace{0.25cm}

Y por último, es importante mencionar que todas las simulaciones se realizan en lazo abierto, lo que implica que todos los resultados obtenidos dependan directamente de la precisión del modelo y de los parámetros geométricos definidos. Todas estas limitaciones no invalidan ningún aspecto del sistema ya definido, pero es importante tenerlas en cuenta a la hora de interpretar los resultados cuando se esté implementando en un entorno físico real.
